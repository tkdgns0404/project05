	...
	<div>
		...
		<form id="updateForm" name="updateForm" method="post" enctype="multipart/form-data">
			...
			<div class="input-group">
				...
				<input type="text" id="phoneNum" name="phoneNum" value="${resultVO.phoneNum}" class="form-control" placeholder="휴대전화를 입력하세요." aria-describedby="basic-addon1">
			</div>
			<div class="input-group">
				<span class="input-group-addon" id="basic-addon1">생년월일</span>
				<input type="text" id="birth" name="birth" value="${resultVO.birth}" class="form-control" placeholder="생년월일을 입력하세요. 월/일/년" aria-describedby="basic-addon1">
			</div>
			<div class="input-group">
